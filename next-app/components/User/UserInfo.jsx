    ...
    return (
        <div class="border-b border-gray-200 dark:border-gray-700">
            <ul class="flex flex-wrap -mb-px text-sm font-medium text-center text-gray-500 dark:text-gray-400">
                <li class="mr-2">
                    <a href="/myfavoriteplace/mypage" class="inline-flex items-center justify-center p-4 text-blue-600 border-b-2 border-blue-600 rounded-t-lg active dark:text-blue-500 dark:border-blue-500 group" aria-current="page">
                        <svg class="w-4 h-4 mr-2 text-blue-600 dark:text-blue-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div className="grid grid-cols-4 gap-2 pb-5 m-10 border-b">
                ...
                <div className="my-auto">
                    <span className="flex text-2xl font-bold text-gray-700">
                        {session?.user?.name}
                    </span>
                    <a href="/myfavoriteplace/mypage/edit" className="flex text-gray-500">
                        プロフィールを表示
